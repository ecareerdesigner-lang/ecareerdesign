...
<Card interactive onClick={onInterviewCoach} style={{ textAlign: "center" }}>
        ...
        <Link href="/performance-review/new" style={{ textDecoration: "none" }}>
          <Card interactive style={{ textAlign: "center" }}>
            <ClipboardCheck size={22} color={TOKENS.iconDark} style={{ marginBottom: 10 }} />
            <p style={{ fontSize: 15, fontWeight: 600, margin: 0, color: TOKENS.ink }}>Performance Review Writer</p>
          </Card>
        </Link>
      </div>
...
async function handleAuthSubmit() {
  ...
  async function signInWithGoogle() {
    ...
    try {
      ...
      setAuthError(e?.message || "Could not sign in with Google. Please try again.");
    }
  }
         ...
         <p style={{ fontSize: 18, color: TOKENS.inkSoft, margin: "0 0 32px", maxWidth: 560, lineHeight: 1.5 }}>
          ...
          <Card style={{ background: TOKENS.ink, border: "none" }}>
            ...
            <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: 24, margin: "0 0 8px", color: "#fff" }}>
              Career Dashboard, Interview Coach, Resume Match Scoring &amp; Performance Review Writer
            </h3>
            <p style={{ fontSize: 14, color: "#C9D2DD", margin: "0 0 18px", maxWidth: 520, lineHeight: 1.5 }}>
              Track applications, practice live mock interviews with AI coaching, see how well your resume matches any job posting, and write polished federal performance reviews for mid-year, end-of-year, or end-of-position evaluations.
            </p>
            <Button
              variant="primary"
              onClick={() => {
        ...
        <div style={{ maxWidth: 420, margin: "0 auto" }}>
          ...
          <Card>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "0 0 16px" }}>
              ...
              <span style={{ fontSize: 12.5, color: TOKENS.inkSoft }}>or</span>
              <div style={{ flex: 1, height: 1, background: TOKENS.line }} />
            </div>
            ...
            <Card style={{ background: TOKENS.ink, border: "none", padding: 32 }}>
              ...
              <div style={{ borderTop: "1px solid rgba(255,255,255,0.15)", paddingTop: 20, display: "flex", flexDirection: "column", gap: 16, marginBottom: 28 }}>
                ...
                <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                  <Check size={18} color={TOKENS.accent} style={{ flexShrink: 0, marginTop: 2 }} />
                  <div>
                    <p style={{ fontSize: 15, fontWeight: 600, margin: "0 0 2px", color: "#fff" }}>Performance Review Writer</p>
                    <p style={{ fontSize: 13.5, color: "#C9D2DD", margin: 0, lineHeight: 1.5 }}>
